...
function calculate() {
	...
	debugger;    
		...
		prajag_charges = 700;
			...
			{
				doorStepCharges = 1000; //Nagpur
					$(".l_DoorStepArea").html("NAGPUR"); 
			}
			else if (doorStepVisit == 6) 
			{
				doorStepCharges = 2000; //SOLAPUR 
			...
			{
				extraDoorStepCharges = 500;//Nashik
			...
			{
				extraDoorStepCharges = 2000; //AMRAVATI
			...
			{
				extraDoorStepCharges = 2000; //KARAD 
			...
			{
				extraDoorStepCharges = 2000; //NANDED 
